 ...
 *
 */
class PicklistsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'picklists_external_code_key' => ['type' => 'unique', 'columns' => ['external_code'], 'length' => []],
            'picklists_customer_id_fkey' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
