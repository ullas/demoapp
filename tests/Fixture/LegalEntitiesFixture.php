...
class LegalEntitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'paygroup_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        '_constraints' => [
            ...
            'legal_entities_paygroup_id_fkey' => ['type' => 'foreign', 'columns' => ['paygroup_id'], 'references' => ['pay_groups', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            ...
            'effective_status' => 1,
            'effective_start_date' => '2016-08-17',
            'effective_end_date' => '2016-08-17',
