...
class PositionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'effective_status' => ['type' => 'text', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null],
        ...
        'business_unit' => ['type' => 'string', 'length' => 255, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        ...
        'code' => ['type' => 'string', 'length' => 255, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'positions_code_key' => ['type' => 'unique', 'columns' => ['code'], 'length' => []],
            'positions_business_unit_fkey' => ['type' => 'foreign', 'columns' => ['business_unit'], 'references' => ['business_units', 'external_code'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            ...
            'positions_parent_position_fkey' => ['type' => 'foreign', 'columns' => ['parent_position'], 'references' => ['positions', 'code'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
