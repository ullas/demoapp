...
class JobInfosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'managerid' => ['type' => 'biginteger', 'length' => 20, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'job_infos_person_id_external_key' => ['type' => 'unique', 'columns' => ['person_id_external'], 'length' => []],
            'job_infos_managerid_fkey' => ['type' => 'foreign', 'columns' => ['managerid'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'job_infos_person_id_external_fkey' => ['type' => 'foreign', 'columns' => ['person_id_external'], 'references' => ['emp_data_biographies', 'person_id_external'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            ...
            'position_entry_date' => '2016-08-09',
            ...
            'probation_period_end_date' => '2016-08-09',
            ...
            'expected_return_date' => '2016-08-09',
            ...
            'job_entry_date' => '2016-08-09',
            'time_in_job' => 'Lorem ipsum dolor sit amet',
            'company_entry_date' => '2016-08-09',
            'time_in_company' => 'Lorem ipsum dolor sit amet',
            'location_entry_date' => '2016-08-09',
            'time_in_location' => 'Lorem ipsum dolor sit amet',
            'department_entry_date' => '2016-08-09',
            'time_in_department' => 'Lorem ipsum dolor sit amet',
            'pay_scale_level_entry_date' => '2016-08-09',
            'time_in_pay_scale_level' => 'Lorem ipsum dolor sit amet',
            'hire_date' => '2016-08-09',
            'termination_date' => '2016-08-09',
            'leave_of_absence_start_date' => '2016-08-09',
            'leave_of_absence_return_date' => '2016-08-09',
