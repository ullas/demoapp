 ...
 * @method \App\Model\Entity\Compensation|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Compensation findOrCreate($search, callable $callback = null)
 */
class CompensationTable extends Table
{
