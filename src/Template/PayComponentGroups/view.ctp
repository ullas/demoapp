...
<section class="content">
  <div class="box box-primary"><div class="box-body">
    ...
    <fieldset><?php
            ...
            echo $this->Form->input('status',['disabled' => true,'class'=>'select2','options' => array('1'=>'Active','0'=> 'Inactive'), 'empty' => 'Choose']);
            echo $this->Form->input('start_date',['value' => !empty($payComponentGroup->start_date) ? $payComponentGroup->start_date->format($mptldateformat) : '','class' => 'mptldp','type' => 'text','templateVars' => ['icon' => '<div class="input-group-addon"><i class="fa fa-calendar"></i></div>'],'disabled' => true]);
            echo $this->Form->input('end_date',['value' => !empty($payComponentGroup->end_date) ? $payComponentGroup->end_date->format($mptldateformat) : '','class' => 'mptldp','type' => 'text','templateVars' => ['icon' => '<div class="input-group-addon"><i class="fa fa-calendar"></i></div>'],'disabled' => true]);
