<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $educationalQualification->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $educationalQualification->id)]
            )
        ?></li>
...
<div class="educationalQualifications form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Educational Qualification') ?></legend>
        <?php
