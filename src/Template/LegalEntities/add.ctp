...
<section class="content">
	<div class="box box-primary"><div class="box-body form-horizontal">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo "<div class='form-group'><label class='col-sm-3 control-label'>Effective Start Date:</label><div class='col-sm-6'><div class='input-group'>";
            echo "<div class='input-group-addon''><i class='fa fa-calendar'></i></div><input type='text' class='form-control' id='effective_start_date'></div></div></div>";
            // echo $this->Form->input('effective_end_date', ['empty' => true]);
            echo "<div class='form-group'><label class='col-sm-3 control-label'>Effective End Date:</label><div class='col-sm-6'><div class='input-group'>";
            echo "<div class='input-group-addon''><i class='fa fa-calendar'></i></div><input type='text' class='form-control' id='effective_end_date'></div></div></div>";
