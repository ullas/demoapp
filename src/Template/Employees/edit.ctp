    	...
    	if(empid!="" && empid!=null){
    		...
    		for (i = 1; i <= idclasscount; i++) 
    		{
    			...
    			if(empid!="" && empid!=null && idtype!="" && idtype!=null && nationalid!="" && nationalid!=null){
					...
					sweet_alert("Please enter ID Card type/Id.");break;
					return false;
				} 
				}else{
    				idcounter++;
