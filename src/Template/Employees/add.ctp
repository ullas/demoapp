      ...
      <div class="nav-tabs-custom">
        ...
        <div class=" tab-content">
          ...
          <div class="tab-pane" id="EmpDataPersonal">
            ...
            echo $this->Form->input('emp_data_personal.nationality',['options' => $this->Country->get_countries(), 'empty' => true]);
            echo $this->Form->input('emp_data_personal.second_nationality',['options' => $this->Country->get_countries(), 'empty' => true]);
            echo $this->Form->input('emp_data_personal.third_nationality',['options' => $this->Country->get_countries(), 'empty' => true]);
        ...
        ?>
          ...
          <div class="tab-pane" id="EmploymentInfo">
			...
			echo $this->Form->input('employment_info.seniority_date', ['class' => 'mptldp','empty' => true]);
            echo $this->Form->input('employment_info.benefits_eligibility_start_date', ['class' => 'mptldp','empty' => true]);
            echo $this->Form->input('employment_info.prev_employeeid');
            echo $this->Form->input('employment_info.eligible_for_stock');
			echo $this->Form->input('employment_info.service_date', ['class' => 'mptldp','empty' => true]);
